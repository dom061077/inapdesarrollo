                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="localidades"><g:message code="provincia.localidades.label" default="Localidades" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: provinciaInstance, field: 'localidades', 'errors')}">
...
<g:link controller="localidad" action="create" params="['provincia.id': provinciaInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'localidad.label', default: 'Localidad')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="nombre"><g:message code="provincia.nombre.label" default="Nombre" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: provinciaInstance, field: 'nombre', 'errors')}">
