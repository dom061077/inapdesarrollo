...
<html>
    <head>
        ...
        <script type="text/javascript" src="${g.resource(dir:'js/script/academico/carrera',file:'editcarrera.js')}"></script>        
    ...
    <body>
        ...
        <div class="body">
            ...
            <form onSubmit="initsubmit();return true;" method="post" >
                ...
                <g:hiddenField id="idCarreraId" name="idCarrera" value="${carreraInstance?.id}" />
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" controller="carrera" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
