                ...
                <div id="tabs">
		            ...
		            <div id="tabs-2">
		            	<fieldset>
		                                    ...
		                                    <g:select name="especialidad.id" from="${com.medfire.EspecialidadMedica.list()}" optionKey="id" value="${profesionalInstance?.especialidad?.id}" noSelection="['null': '']" />
		                                    <br/>		                        
		                                    ...
		                                    <bi:hasImage bean="${profesionalInstance}">
			                                    <bi:img size="large" bean="${profesionalInstance}" />
											</bi:hasImage>
											<br/>			                                    		 
