        ...
        <script type="text/javascript">
        	jQuery(document).ready(function(){
				jQuery("#list").jqGrid({
					...
					datatype: "json",
					width:680,
					colNames:['Nro.Insc.','Apellido Alumno','Nombre Alumno','Carrera','Año Lectivo','Estado Matrícula','Estado Inscripción','Opciones'],
				   	colModel:[
                        ...
                        {name:'matricula_estado',index:'matricula_estado', width:100,search:false,sortable:false},
                        {name:'estado',index:'estado', width:100,search:false,sortable:false},
					...
					gridComplete: function(){ 
						...
						for(var i=0;i < ids.length;i++){ 
							...
							be = "<a title='Confirmar' href='edit/"+ids[i]+"'><span class='ui-icon ui-icon-pencil' style='float:left;margin: 3px 3px 3px 5px'  ></span></a>";
