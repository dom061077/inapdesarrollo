...
class AlumnoController {
	...
	def saveregister = {
		...
		if(fechaNacimientoError){
			...
			alumnoInstance.errors.rejectValue("fechaNacimiento","com.educacion.alumno.Alumno.fechaNacimiento.date.error","Ingrese una fecha correcta, se sugiere una correci√≥n")
		...
		if (recaptchaOK && alumnoInstance.save(flush: true)) {
			...
			if(!recaptchaOK)
				alumnoInstance.errors.rejectValue("id","com.educacion.alumno.Alumno.captcha.error","Ingrese un cÛdigo de pueba correcto al pie de la p·gina")
			render(view: "register", model: [alumnoInstance: alumnoInstance])
		}
	}
    ...
    def update = {
        ...
        if (alumnoInstance) {
			Alumno.withTransaction{TransactionStatus status->
					...
					if(fechaNacimientoError){
						alumnoInstance.validate()
						alumnoInstance.errors.rejectValue("fechaNacimiento","com.medfire.alumno.Alumno.fechaNacimiento.date.error","Ingrese una fecha correcta, se sugiere una correci√≥n")
