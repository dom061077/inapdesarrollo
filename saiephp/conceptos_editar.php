...
$pantalla="Editar Conceptos Código: ".$_GET['id']; 
?>
<?php
...
$query_Recordset1 = sprintf("SELECT codigoconcepto, descripcion, tipo FROM conceptos WHERE codigoconcepto = %s", GetSQLValueString($colname_Recordset1, "text"));
...
mysql_select_db($database_dbo, $dbo);
$sql= sprintf("SELECT codigoconcepto FROM ingresos WHERE codigoconcepto = %s UNION SELECT codigoconcepto FROM egresos WHERE codigoconcepto = %s",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $insertSQL = sprintf("UPDATE conceptos SET descripcion=%s, tipo=%s WHERE codigoconcepto =%s",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <br class="clearfloat" />
  <p class="cerrar"><a href="<?echo $path;?>conceptos.php">Volver</a></p>
  <br class="clearfloat" />
