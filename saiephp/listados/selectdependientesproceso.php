...
if(validaSelect($selectDestino) && validaOpcion($opcionSeleccionada))
{
	if ($_GET["select"]=='select2'){
		...
		$consulta=mysql_query("SELECT codigotalonario, CONCAT(LPAD(numerodesde, 8, '0'), ' - ', LPAD(numerohasta, 8, '0')) FROM talonarios WHERE codigocomprobante='$opcionSeleccionada'") or die(mysql_error());
