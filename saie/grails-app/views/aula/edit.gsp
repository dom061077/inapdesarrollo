    ...
    <head>
    	...
    	$(document).ready(function(){
    		...
    		jQuery("#busquedacarreraId").jqGrid('filterToolbar',{stringResult: true,searchOnEnter : true});
   			...
   			,width:600
   			,rownumbers:true
   			,colNames:['Id','IdId','Denominación','Observación']
   			,colModel:[ 
   				...
   				, {name:'denominacion',index:'denominacion', width:80, align:"left",editable:true,editoptions:{readOnly:true,size:30},editrules:{required:true}, sortable:false}
