...
//---------------------------------- 
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${docenteInstance?.version}" />
					   ...
					   <div class="clear"></div>
						...
						<div class="span-3 spanlabel">
							<label for="localidadDomicilio"><g:message code="docente.localidadDomicilio.label" default="Localidad Domicilio" /></label>
						</div>
						<div class="span-5">
 ...
 <g:hiddenField id="localidadDomicilioIdId" name="localidadDomicilio.id" value="${localidadDomicilio?.id}" />
					   ...
					   <div class="clear"></div>
						...
						<div class="span-3 spanlabel">
							<label for="provinciaNacimiento"><g:message code="docente.provinciaNacimiento.label" default="Provincia Nacimiento" /></label>
						</div>
						<div class="span-5">
							<g:textField class="ui-widget ui-corner-all ui-widget-content" id="provinciaNacimientoId" name="provinciaNacimientoDesc"  value="colocar el valor del field descripcion" /> 
