...
class LoginController {
	...
	def openIdAuthenticate = {
		...
		try {
			...
			log.debug "REDIRECURL: "+redirectUrl
		}
	...
	def authAjax = {
		...
		session.removeAttribute(APF.SPRING_SECURITY_SAVED_REQUEST_KEY)
	...
	def authfail = {
		...
		if (exception) {
			if (exception instanceof DisabledException) {
				...
				msg = "[$username]"+ g.message(code:"default.usuariocontrasenia.incorrecto")
			}
		}
