<html>
	<head>
        ...
        <script type="text/javascript" src="${resource(dir:"js/script/consulta",file:"pacientesatendidosporos.js")}"></script>
	...
	<body>
		...
		<div class="body">
            <h1>Pacientes Atendidos por O.S</h1>
            ...
            <g:form action="pacientesatendidosporosbuscar">
		            <div class="span-20">
		   				<fieldset>
