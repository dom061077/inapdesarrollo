<?php
$pantalla='Generar Informe de Historial de Pagos';
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertGoTo = "imp_historialpago.php?anio=".$_POST['PAnio']."&concepto=".$_POST['Concepto'];
	...
	$_SQL = sprintf("INSERT INTO logging (usuario, fecha, tipotransaccion, descripcion) VALUES (%s, now(), %s, %s)",
				...
				GetSQLValueString("Historial de pagos periodo ".$_POST['PAnio'], "text"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <td width="66" align="right" nowrap="nowrap"><div align="center">Per&iacute;odo:</div></td>
      <td width="228"><span id="sprytextfield1">
