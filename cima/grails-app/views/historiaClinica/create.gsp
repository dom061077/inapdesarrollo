            			...
            			<div class="span-21">
	            				<fieldset>
	            					...
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t1"><g:antecedenteLabel field="t1Label"/>:</label>
	            						<br/>
	            						<input type="checkbox" id="checklabel1Id" indice="1" name="consulta.antecedente.t1Check" />
	            						<g:textField id="antecedentet1Id" class="inputlarge" name="consulta.antecedente.t1" value="${consultaInstance.antecedente?.t1}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t2"><g:antecedenteLabel field="t2Label"/>:</label>
	            						<br/>	            						
	            						<g:checkBox id="checklabel2Id" indice="2"   name="consulta.antecedente.t2Check" value="${consultaInstance.antecedente?.t2Check}"></g:checkBox>
	            						<g:textField id="antecedentet2Id" class="inputlarge" name="consulta.antecedente.t2" value="${consultaInstance.antecedente?.t2}"></g:textField>
	            					</div>

	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t3"><g:antecedenteLabel field="t3Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel3Id" indice="3"   name="consulta.antecedente.t3Check" value="${consultaInstance.antecedente?.t3Check}" ></g:checkBox>
	            						<g:textField id="antecedentet3Id" class="inputlarge" name="consulta.antecedente.t3" value="${consultaInstance.antecedente?.t3}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t4"><g:antecedenteLabel field="t4Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel4Id" indice="4"   name="consulta.antecedente.t4Check" value="${consultaInstance.antecedente?.t4Check}"></g:checkBox>
	            						<g:textField id="antecedentet4Id" class="inputlarge" name="consulta.antecedente.t4" value="${consultaInstance.antecedente?.t4}"></g:textField>
	            					</div>

	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t5"><g:antecedenteLabel field="t5Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel5Id" indice="5"   name="consulta.antecedente.t5Check" value="${consultaInstance.antecedente?.t5Check}"></g:checkBox>
	            						<g:textField id="antecedentet5Id" class="inputlarge" name="consulta.antecedente.asmaBronquial" value="${consultaInstance.antecedente?.t5}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t6"><g:antecedenteLabel field="t6Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel6Id" indice="6"   name="consulta.antecedente.t6Check" value="${consultaInstance.antecedente?.t6Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet6Id" class="inputlarge" name="consulta.antecedente.t6" value="${consultaInstance.antecedente?.t6}"></g:textField>
	            					</div>
	            					
	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t7"><g:antecedenteLabel field="t7Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel7Id" indice="7"   name="consulta.antecedente.t7Check" value="${consultaInstance.antecedente?.t7Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet7Id" class="inputlarge" name="consulta.antecedente.t7" value="${consultaInstance.antecedente?.t7}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t8"><g:antecedenteLabel field="t8Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel8Id" indice="8"   name="consulta.antecedente.t8Check" value="${consultaInstance.antecedente?.t8Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet8Id" class="inputlarge" name="consulta.antecedente.t8" value="${consultaInstance.antecedente?.t8}"></g:textField>
	            					</div>

	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t9"><g:antecedenteLabel field="t9Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel9Id" indice="9"   name="consulta.antecedente.t9Check" value="${consultaInstance.antecedente?.t9Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet9Id" class="inputlarge" name="consulta.antecedente.t9" value="${consultaInstance.antecedente?.t9}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t10"><g:antecedenteLabel field="t10Label"  />:</label>
	            						<br/>
	            						<g:checkBox id="checklabel10Id" indice="10"   name="consulta.antecedente.t10Check" value="${consultaInstance.antecedente?.t10Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet10Id" class="inputlarge" name="consulta.antecedente.t10" value="${consultaInstance.antecedente?.t10}"></g:textField>
	            					</div>


	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t11"><g:antecedenteLabel field="t11Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel11Id" indice="11"   name="consulta.antecedente.t11Check"  value="${consultaInstance.antecedente?.t11Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet11Id" class="inputlarge" name="consulta.antecedente.t11" value="${consultaInstance.antecedente?.t11}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t12"><g:antecedenteLabel field="t12Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel12Id" indice="12"   name="consulta.antecedente.t12Check"  value="${consultaInstance.antecedente?.t12Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet12Id" class="inputlarge" name="consulta.antecedente.t12" value="${consultaInstance.antecedente?.t12}"></g:textField>
	            					</div>
	            					
	            					<div class="clear"></div>	            					
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.nefropatia"><g:antecedenteLabel field="t13Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel13Id" indice="13"   name="consulta.antecedente.t13Check"  value="${consultaInstance.antecedente?.t13Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet13Id" class="inputlarge" name="consulta.antecedente.t13" value="${consultaInstance.antecedente?.t13}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t14"><g:antecedenteLabel field="t14Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel14Id" indice="14"   name="consulta.antecedente.t14Check"  value="${consultaInstance.antecedente?.t14Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet14Id" class="inputlarge" name="consulta.antecedente.t14" value="${consultaInstance.antecedente?.t14}"></g:textField>
	            					</div>
	            					

	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t15"><g:antecedenteLabel field="t15Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel15Id" indice="15"   name="consulta.antecedente.t15Check" value="${consultaInstance.antecedente?.t15Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet15Id" class="inputlarge" name="consulta.antecedente.t15" value="${consultaInstance.antecedente?.t15}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t16"><g:antecedenteLabel field="t16Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel16Id" indice="16"   name="consulta.antecedente.t16Check" value="${consultaInstance.antecedente?.t16Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet16Id" class="inputlarge" name="consulta.antecedente.t16" value="${consultaInstance.antecedente?.t16}"></g:textField>
	            					</div>

	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t17"><g:antecedenteLabel field="t17Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel17Id" indice="17"   name="consulta.antecedente.t17Check" value="${consultaInstance.antecedente?.t17Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet17Id" class="inputlarge" name="consulta.antecedente.t17" value="${consultaInstance.antecedente?.t17}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t18"><g:antecedenteLabel field="t18Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel18Id" indice="18"   name="consulta.antecedente.t18Check" value="${consultaInstance.antecedente?.t18Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet18Id" class="inputlarge" name="consulta.antecedente.t18" value="${consultaInstance.antecedente?.t18}"></g:textField>
	            					</div>
	            					
	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t19"><g:antecedenteLabel field="t19Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel19Id" indice="19"   name="consulta.antecedente.t19Check"  value="${consultaInstance.antecedente?.t19Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet19Id" class="inputlarge" name="consulta.antecedente.t19" value="${consultaInstance.antecedente?.t19}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t20"><g:antecedenteLabel field="t20Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel20Id" indice="20"   name="consulta.antecedente.t20Check" value="${consultaInstance.antecedente?.t20Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet20Id" class="inputlarge" name="consulta.antecedente.t20" value="${consultaInstance.antecedente?.t20}"></g:textField>
	            					</div>
	            					
	            					<div class="clear"></div>
	            					<div class="span-9 colborder">
	            						<label for="consulta.antecedente.t21"><g:antecedenteLabel field="t21Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel21Id" indice="21"   name="consulta.antecedente.t21Check" value="${consultaInstance.antecedente?.t21Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet21Id" class="inputlarge" name="consulta.antecedente.t21" value="${consultaInstance.antecedente?.t21}"></g:textField>
	            					</div>
	            					<div class="span-9">
	            						<label for="consulta.antecedente.t22"><g:antecedenteLabel field="t22Label"/>:</label>
	            						<br/>
	            						<g:checkBox id="checklabel22Id" indice="22"   name="consulta.antecedente.t22Check"  value="${consultaInstance.antecedente?.t22Check}"></g:checkBox>	            						
	            						<g:textField id="antecedentet22Id" class="inputlarge" name="consulta.antecedente.t22" value="${consultaInstance.antecedente?.t22}"></g:textField>
	            					</div>
	            				...
	            				<fieldset>
	            					...
	            					<div class="span-9">
	            						<label for="consulta.antecedente.antecedenteFamiliar">Antecedentes Familiares:</label>
	            						<br/>
	            						<g:textArea class="textareastudio" name="consulta.antecedente.antecedenteFamiliar" value="${consultaInstance.antecedente?.antecedenteFamiliar}"></g:textArea>
	            					</div>
	            				</fieldset>
						</div>					
