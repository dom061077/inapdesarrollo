    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="password"
                              title="${message(code: 'person.password.label', default: 'Password')}"/>
            
            <th><g:message code="person.profesionalAsignado.label" default="Profesional Asignado"/></th>
            
            <g:sortableColumn property="esProfesional"
                              title="${message(code: 'person.esProfesional.label', default: 'Es Profesional')}"/>
        ...
        <g:each in="${personInstanceList}" status="i" var="personInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td>${fieldValue(bean: personInstance, field: "profesionalAsignado")}</td>
                
                <td><g:formatBoolean boolean="${personInstance.esProfesional}"/></td>
