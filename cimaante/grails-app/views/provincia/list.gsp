                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'provincia.id.label', default: 'Id')}" />
                    ...
                    <g:each in="${provinciaInstanceList}" status="i" var="provinciaInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${provinciaInstance.id}">${fieldValue(bean: provinciaInstance, field: "id")}</g:link></td>
